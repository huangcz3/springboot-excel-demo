...
public class ExportMapExcel {
    ...
    public HSSFWorkbook exportExcel(HSSFWorkbook workbook,String sheetName, List<String> headersName, List<String> headersId,
    ...
    public static void main(String[] args) {
        ...
        workbook = exportExcelUtil.exportExcel(workbook,"测试POI导出EXCEL文档1", listName, listId, listB);
        workbook = exportExcelUtil.exportExcel(workbook,"测试POI导出EXCEL文档2", listName, listId, listB);
